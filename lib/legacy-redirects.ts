...
export const legacyRedirects: LegacyRedirect[] = [
  ...
  to("/dozhimnye-kompressory-serii-mistral", "/catalog/hp/hp-piston"),
  to("/kompressory-passat-15-40-bar", "/catalog/hp/hp-piston"),
  to("/kompressory-serii-6000", "/catalog/hp/hp-piston"),
  to("/kompressory-serii-mistral-2-stupeni-szhatiya-vozdushnoe-okhlazhdenie", "/catalog/hp/hp-piston"),
  to("/kompressory-serii-passat-3-stupeni-szhatiya-vozdushnoe-okhlazhdenie", "/catalog/hp/hp-piston"),
  to("/kompressory-serii-typhoon-2-stupeni-szhatiya-vodyanoe-okhlazhdenie", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-5000-50-350-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-6000-50-500-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-hurricane-100-230-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-hurricane-90-400-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-mistral-8-40-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-passat-10-80-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-tornado-100-230-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-tornado-50-420-bar", "/catalog/hp/hp-piston"),
  to("/porshnevye-kompressory-vysokogo-davleniya-serii-typhoon-10-100-bar", "/catalog/hp/hp-piston"),
  ...
  to("/osushiteli-hre-hrg-hrs", "/catalog/dryers/dryer-hot"),
  ...
  to("/catalog/generators/generators-omegaair", "/catalog/generators"),
  to("/catalog/generators/generators-omegaair/:path*", "/catalog/generators"),
